...
joint_limits(2,:)=[0,2*pi];
joint_limits(3,:)=[0,2*pi];
joint_limits(4,:)=[0,2*pi];
joint_limits(5,:)=[0,2*pi];
joint_limits(6,:)=[0,2*pi];
task_space=zeros(6,0);        %define task space
...
%link4
f_c(:,4)=[0;-199*0.5-35;0]/1000;
b_dim(:,4)=[50;199;50]/1000;
